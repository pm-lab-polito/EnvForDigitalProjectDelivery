...
class CustomAdditionalBudgetManager(admin.ModelAdmin):
    ordering = ('budget',) 
    list_display = ('budget', 'amount', 'date', 'status',)
    search_fields = ('budget', 'amount')
    readonly_fields = ('id',)
...
admin.site.register(AdditionalBudget, CustomAdditionalBudgetManager)
